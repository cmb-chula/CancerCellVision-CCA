...
# img_norm_cfg = dict(
#     mean=[14.45963332, 14.45963332, 14.45963332, 0.36220225, 1.25987821, 0.94261943], 
#     std=[3.12931179, 3.12931179, 3.12931179, 2.03135585, 8.19185153, 6.43936662], 
#     to_rgb=False)
# img_norm_cfg = dict(
#     mean=[14.45963332, 14.45963332, 14.45963332, 0, 0, 0], 
#     std=[3.12931179, 3.12931179, 3.12931179, 1, 1, 1], 
#     to_rgb=False)
img_norm_cfg = dict(
    mean=[0, 0, 0, 0, 0, 0], 
    std=[1, 1, 1, 1, 1, 1], 
