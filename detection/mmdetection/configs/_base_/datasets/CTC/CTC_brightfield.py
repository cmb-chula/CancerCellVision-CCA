...
train_pipeline = [
    dict(type='LoadCTCImageFromFile', to_float32 = True, blue_input = False, fl_input = False, normalize = True),
    ...
    dict(
        type='PackDetInputs',
        meta_keys=('img', 'gt_bboxes', 'gt_bboxes_labels', 'pad_shape','img_shape'))
...
evaluation = dict(type='VOCMetric', metric='mAP', eval_mode='11points')
